...
const CharacterAscensionATK = (props) => {
    ...
    React.useEffect(() => {
        updateCharacterCosts([name, GetCost(sliderValue[0], sliderValue[1]), "attack"])
        updateTotalCosts()
    })
...
export default connect(null, mapDispatchToProps)(CharacterAscensionATK);
