...
const CharacterAscensionSkill = (props) => {
    ...
    React.useEffect(() => {
        updateCharacterCosts([name, GetCost(sliderValue[0], sliderValue[1]), "skill"])
        updateTotalCosts()
    })
...
export default connect(null, mapDispatchToProps)(CharacterAscensionSkill);
