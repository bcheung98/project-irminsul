...
const AscensionStatFilters = (props) => {
    ...
    return (
        <React.Fragment>
            ...
            <CustomTooltip title="Healing Bonus" arrow placement="top">
            ...
            <CustomTooltip title="Pyro DMG Bonus" arrow placement="top">
            ...
            <CustomTooltip title="Hydro DMG Bonus" arrow placement="top">
            ...
            <CustomTooltip title="Electro DMG Bonus" arrow placement="top">
            ...
            <CustomTooltip title="Cryo DMG Bonus" arrow placement="top">
            ...
            <CustomTooltip title="Anemo DMG Bonus" arrow placement="top">
            ...
            <CustomTooltip title="Geo DMG Bonus" arrow placement="top">
            ...
            <CustomTooltip title="Dendro DMG Bonus" arrow placement="top">
