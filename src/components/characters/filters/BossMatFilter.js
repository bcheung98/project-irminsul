...
let basaltPillarIcon = (`${process.env.REACT_APP_URL}/materials/boss_mats/Basalt_Pillar.png`);
let cleansingHeartIcon = (`${process.env.REACT_APP_URL}/materials/boss_mats/Cleansing_Heart.png`);
let everflameSeedIcon = (`${process.env.REACT_APP_URL}/materials/boss_mats/Everflame_Seed.png`);
let hoarfrostCoreIcon = (`${process.env.REACT_APP_URL}/materials/boss_mats/Hoarfrost_Core.png`);
let hurricaneSeedIcon = (`${process.env.REACT_APP_URL}/materials/boss_mats/Hurricane_Seed.png`);
let lightningPrismIcon = (`${process.env.REACT_APP_URL}/materials/boss_mats/Lightning_Prism.png`);
let juvenileJadeIcon = (`${process.env.REACT_APP_URL}/materials/boss_mats/Juvenile_Jade.png`);
let crystallineBloomIcon = (`${process.env.REACT_APP_URL}/materials/boss_mats/Crystalline_Bloom.png`);
let marionetteCoreIcon = (`${process.env.REACT_APP_URL}/materials/boss_mats/Marionette_Core.png`);
let perpetualHeartIcon = (`${process.env.REACT_APP_URL}/materials/boss_mats/Perpetual_Heart.png`);
let smolderingPearlIcon = (`${process.env.REACT_APP_URL}/materials/boss_mats/Smoldering_Pearl.png`);
let dewIcon = (`${process.env.REACT_APP_URL}/materials/boss_mats/Dew_of_Repudiation.png`);
let stormBeadIcon = (`${process.env.REACT_APP_URL}/materials/boss_mats/Storm_Beads.png`);
let riftbornRegaliaIcon = (`${process.env.REACT_APP_URL}/materials/boss_mats/Riftborn_Regalia.png`);
let dragonheirIcon = (`${process.env.REACT_APP_URL}/materials/boss_mats/Dragonheir's_False_Fin.png`);
let runicFangIcon = (`${process.env.REACT_APP_URL}/materials/boss_mats/Runic_Fang.png`);
let majesticBeakIcon = (`${process.env.REACT_APP_URL}/materials/boss_mats/Majestic_Hooked_Beak.png`);
let thunderclapCoreIcon = (`${process.env.REACT_APP_URL}/materials/boss_mats/Thunderclap_Fruitcore.png`);
let lgtIcon = (`${process.env.REACT_APP_URL}/materials/boss_mats/Light_Guiding_Tetrahedron.png`);
