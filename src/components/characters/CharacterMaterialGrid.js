        ...
        <Grid item sm sx={{mt: "-3px"}}>
            <Grid style={materialRow}>
                <MaterialTooltip title={formatTalents(talentBook)} arrow placement="top">
                    <img style={materialImage} src={require(`../../assets/materials/talent_mats/${talentBook}3.png`)} alt={talentBook} />
                </MaterialTooltip>
                <MaterialTooltip title={formatWeeklyBossMats(weeklyBossMat)} arrow placement="top">
                    <img style={materialImage} src={require(`../../assets/materials/weekly_boss_mats/${weeklyBossMat.split(" ").join("_")}.png`)} alt={weeklyBossMat} />
                </MaterialTooltip>
                <MaterialTooltip title={formatCommonMats(commonMat)} arrow placement="top">
                    <img style={materialImage} src={require(`../../assets/materials/common_mats/${commonMat.split(" ").join("_")}3.png`)} alt={commonMat} />
                </MaterialTooltip>
            </Grid>
            <Grid style={materialRow}>
                <MaterialTooltip title={formatBossMats(bossMat)} arrow placement="top">
                    <img style={materialImage} src={require(`../../assets/materials/boss_mats/${bossMat.split(" ").join("_")}.png`)} alt={bossMat} />
                </MaterialTooltip>
                <MaterialTooltip title={localMat} arrow placement="top">
                    <img style={materialImage} src={require(`../../assets/materials/local_specialties/${localMat.split(" ").join("_")}.png`)} alt={localMat} />
                </MaterialTooltip> 
                <MaterialTooltip title={formatGemstone(element)} arrow placement="top">
                    <img style={materialImage} src={require(`../../assets/materials/ascension_gems/${element}_Gemstone.png`)} alt={element} />
                </MaterialTooltip>
            </Grid>
        </Grid>
    )
