                                    ...
                                    <div style={{ display: "flex" }}>
                                        ...
                                        {row.quantity[1] !== "0" &&
                                            <div className="materialImageRoot">
                                                <MaterialTooltip title={formatBossMats(bossMat)} arrow placement="top">
                                                    <img className="materialImage" style={{ backgroundImage: "url(" + background4star + ")", backgroundSize: "100%" }} src={(`${process.env.REACT_APP_URL}/materials/boss_mats/${bossMat.split(" ").join("_")}.png`)} alt={bossMat} onError={ErrorLoadingImage} />
                                                </MaterialTooltip>
                                                <div className="materialTextContainer">
                                                    {row.quantity[1]}
                                                </div>
                                        ...
                                        <div className="materialImageRoot">
                                            <MaterialTooltip title={localMat} arrow placement="top">
                                                <img className="materialImage" style={{ backgroundImage: "url(" + background1star + ")", backgroundSize: "100%" }} src={(`${process.env.REACT_APP_URL}/materials/local_specialties/${localMat.split(" ").join("_")}.png`)} alt={localMat} onError={ErrorLoadingImage} />
                                            </MaterialTooltip>
                                            <div className="materialTextContainer">
                                                {row.quantity[2]}
                                            </div>
                                        ...
                                        <div className="materialImageRoot">
                                            <MaterialTooltip title={formatGemstone(`${element}_${ascensionLegend.gemstone[row.ascLevel]}`)} arrow placement="top">
                                                <img className="materialImage" style={gemstoneBackgroundImageLegend(row.ascLevel)} src={(`${process.env.REACT_APP_URL}/materials/ascension_gems/${element}_${ascensionLegend.gemstone[row.ascLevel]}.png`)} alt={element} onError={ErrorLoadingImage} />
                                            </MaterialTooltip>
                                            <div className="materialTextContainer">
                                                {row.quantity[0]}
                                            </div>
                                        ...
                                        {row.total[0] !== "0" &&
                                            <div className="materialImageRoot">
                                                <MaterialTooltip title={formatGemstone(`${element}_Sliver`)} arrow placement="top">
                                                    <img className="materialImage" style={{ backgroundImage: "url(" + background2star + ")" }} src={(`${process.env.REACT_APP_URL}/materials/ascension_gems/${element}_Sliver.png`)} alt={element} onError={ErrorLoadingImage} />
                                                </MaterialTooltip>
                                                <div className="materialTextContainer">
                                                    {row.total[0]}
                                                </div>
                                        ...
                                        {row.total[1] !== "0" &&
                                            <div className="materialImageRoot">
                                                <MaterialTooltip title={formatGemstone(`${element}_Fragment`)} arrow placement="top">
                                                    <img className="materialImage" style={{ backgroundImage: "url(" + background3star + ")" }} src={(`${process.env.REACT_APP_URL}/materials/ascension_gems/${element}_Fragment.png`)} alt={element} onError={ErrorLoadingImage} />
                                                </MaterialTooltip>
                                                <div className="materialTextContainer">
                                                    {row.total[1]}
                                                </div>
                                        ...
                                        {row.total[2] !== "0" &&
                                            <div className="materialImageRoot">
                                                <MaterialTooltip title={formatGemstone(`${element}_Chunk`)} arrow placement="top">
                                                    <img className="materialImage" style={{ backgroundImage: "url(" + background4star + ")" }} src={(`${process.env.REACT_APP_URL}/materials/ascension_gems/${element}_Chunk.png`)} alt={element} onError={ErrorLoadingImage} />
                                                </MaterialTooltip>
                                                <div className="materialTextContainer">
                                                    {row.total[2]}
                                                </div>
                                        ...
                                        {row.total[3] !== "0" &&
                                            <div className="materialImageRoot">
                                                <MaterialTooltip title={formatGemstone(`${element}_Gemstone`)} arrow placement="top">
                                                    <img className="materialImage" style={{ backgroundImage: "url(" + background5star + ")" }} src={(`${process.env.REACT_APP_URL}/materials/ascension_gems/${element}_Gemstone.png`)} alt={element} onError={ErrorLoadingImage} />
                                                </MaterialTooltip>
                                                <div className="materialTextContainer">
                                                    {row.total[3]}
                                                </div>
