export const CharacterAscensionStatScalings = (rarity: number, ascensionStat: string) => {
    ...
    if (ascensionStat === "Healing Bonus") {
        stats[ascensionStat as keyof typeof stats] = ["0%", "0%", "0%", "0%", "5.5%", "5.5%", "11.1%", "11.1%", "11.1%", "11.1%", "16.6%", "16.6%", "22.2%", "22.2%"]
    }
    ...
    if (ascensionStat === "Energy Recharge") {
        if (rarity === 4) {
            stats[ascensionStat as keyof typeof stats] = ["0%", "0%", "0%", "0%", "6.7%", "6.7%", "13.3%", "13.3%", "13.3%", "13.3%", "20%", "20%", "26.7%", "26.7%"]
        }
        if (rarity === 5) {
            stats[ascensionStat as keyof typeof stats] = ["0%", "0%", "0%", "0%", "8%", "8%", "16%", "16%", "16%", "16%", "24%", "24%", "32%", "32%"]
        }
    }
    ...
    if (ascensionStat === "Elemental Mastery") {
        if (rarity === 4) {
            stats[ascensionStat as keyof typeof stats] = ["0", "0", "0", "0", "24", "24", "48", "48", "48", "48", "72", "72", "96", "96"]
        }
        if (rarity === 5) {
            stats[ascensionStat as keyof typeof stats] = ["0", "0", "0", "0", "28.8", "28.8", "57.6", "57.6", "57.6", "57.6", "86.4", "86.4", "115.2", "115.2"]
        }
    }
