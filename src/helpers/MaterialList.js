...
export const CharXPMats = ["char_xp1", "char_xp2", "char_xp3"]

export const WepXPMats = ["wep_xp1", "wep_xp2", "wep_xp3"]
...
export const LocalMats = {
    ...
    "Fontaine": ["Beryl Conch", "Lumidouce Bell", "Rainbow Rose", "Romaritime Flower", "Lumitoile", "Subdetection Unit"]
}
...
export const EliteMats = ["Horn", "Ley Line Branch", "Chaos Part", "Mist Grass", "Sacrificial Knife", "Bone Shard", "Sentinel Chaos Part", "Mirror Maiden Prism", "Riftwolf Claw", "Statuette", "Fungal Nucleus", "Drake Chaos Part", "Primal Construct Prism", "Shell", "Flower", "Tainted Water", "Rift Core", "Watch"]